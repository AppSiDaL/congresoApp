...
function ExploreScreen({ route }) {
  ...
  useEffect(() => {
    if (Actividades) {
      axios
        .get(global.host + "getAllActivities.php", {
          params: {
  ...
  return (
    <>
      ...
      >
        ...
        >
          <Text style={styles.textButton2}>Tuyos</Text>
        </Pressable>
        <Pressable
        ...
        >
          <Text style={[{ color: "white" }, styles.textButton2]}>Explora</Text>
        </Pressable>
      </View>
        ...
        <ScrollView style={styles.scrollView}>
          {dataArray.map((item) => {
            return (
              ...
              >
                <View style={styles.cardDetails} key={"Card" + item[0]["id"]}>
                  ...
                  >
                    <Text key={"Tipo" + item[0]["id"]}>{item[0]["tipo"]}</Text>
